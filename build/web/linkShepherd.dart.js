...
["dart.dom.html", "dart:html", , W, {
  ...
  _MultiElementCssClassSet: {
    ...
    remove$1: function(_, value) {
      return this._elementCssClassSetIterable.fold$2(0, false, new W._MultiElementCssClassSet_remove_closure(value));
    },
...
["", "linkShepherd.dart", , Y, {
  "^": "",
  main: [function() {
    Y.init_query_slectors();
    $.authenticated = false;
  }, "call$0", "main$closure", 0, 0, 1],
  init_query_slectors: function() {
    $.menu_content = document.querySelector("#menu_content");
    $.toggle_menu = document.querySelector("#open_menu");
    $.post_list = document.querySelector("#post_list");
    var t1 = J.get$onClick$x($.toggle_menu);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.init_query_slectors_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    $.account_label = document.querySelector("#account");
    $.login_label = document.querySelector("#login_box");
    J.get$classes$x($.account_label).toggle$2("hidden", !$.authenticated);
    J.get$classes$x($.login_label).toggle$2("hidden", $.authenticated);
    $.sign_in = document.querySelector("#sign_in");
    $.all_tabs = new W._FrozenElementList(document.querySelectorAll(".menu_tab"));
    t1 = document.querySelector("#hot_tab");
    $.hot_tab = t1;
    t1 = J.get$onClick$x(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.init_query_slectors_closure0()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = document.querySelector("#newest_tab");
    $.newest_tab = t1;
    t1 = J.get$onClick$x(t1);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new Y.init_query_slectors_closure1()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  makeRequestNewest: function() {
    C.HttpRequest_methods.getString$1(new XMLHttpRequest(), "http://127.0.0.1:8080/newest").then$1(new Y.makeRequestNewest_closure()).catchError$1(new Y.makeRequestNewest_closure0());
  },
  init_query_slectors_closure: {
    "^": "Closure:2;",
    call$1: function(e) {
      var t1, t2;
      J.get$classes$x($.menu_content).toggle$1("hidden");
      t1 = J.get$classes$x($.menu_content).readClasses$0().contains$1(0, "hidden");
      t2 = $.post_list;
      if (t1)
        J.set$paddingLeft$x(t2.style, "20px");
      else
        J.set$paddingLeft$x(t2.style, "200px");
      return;
    }
  },
  init_query_slectors_closure0: {
    "^": "Closure:2;",
    call$1: function(e) {
      var t1 = $.all_tabs;
      t1.toString;
      W._MultiElementCssClassSet$(t1).remove$1(0, "menu_tab_selected");
      J.get$classes$x($.hot_tab).add$1(0, "menu_tab_selected");
      return;
    }
  },
  init_query_slectors_closure1: {
    "^": "Closure:2;",
    call$1: function(e) {
      var t1 = $.all_tabs;
      t1.toString;
      W._MultiElementCssClassSet$(t1).remove$1(0, "menu_tab_selected");
      J.get$classes$x($.newest_tab).add$1(0, "menu_tab_selected");
      P.print("newest tab has been clickt");
      Y.makeRequestNewest();
      return;
    }
  },
  makeRequestNewest_closure: {
    "^": "Closure:4;",
    call$1: function(newestContent) {
      var t1 = $.post_list;
      t1.toString;
      t1.appendChild(document.createTextNode(newestContent));
    }
  },
  makeRequestNewest_closure0: {
    "^": "Closure:16;",
    call$1: function(error) {
      var t1, t2;
      t1 = $.post_list;
      t2 = error.toString$0(0);
      t1.toString;
...
//# sourceMappingURL=linkShepherd.dart.js.map
